  ...
  return (
    <div>
        <footer>
            ...
            <ul id="footer-info">
              <li id="footer-info-lastmod"> This page was last edited on 10 Aug 2022, at 20:31.</li>
              <li id="footer-info-copyright">Files are available under licenses specified on their description page. All structured data from the file namespace is available under the Creative Commons CC0 License all unstructured text is available under the Creative Commons Attribution - ShareAlike License
                  additional terms may apply.
                  By using this site, you agree to the Terms of Use and the Privacy Policy.</li>
               <li id="homies">Designed by yours truly Ananyeli, Juan, Jahni, Ethan, Alejandro</li>   
            </ul>
